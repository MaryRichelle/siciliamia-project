...
const TeatroGrecoSiracusaHd1Icon = styled.img`
  position: relative;
...
const TeatroGrecoDi = styled.b`
  ...
  flex-shrink: 0;
`;
const TeatroGrecoSiracusaHd1Parent = styled.div`
...
const CardBest = () => {
  return (
    <CardBestRoot>
      <Hotel1>
        <TeatroGrecoSiracusaHd1Parent>
          <TeatroGrecoSiracusaHd1Icon
            alt=""
            src="/teatrogrecosiracusahd-1@2x.png"
          />
          <TeatroGrecoDi>Teatro greco di Siracusa</TeatroGrecoDi>
        </TeatroGrecoSiracusaHd1Parent>
        <BottomFooter />
      </Hotel1>
      <FromParent>
