...
const TaorminaTeatro1Icon = styled.img`
  position: relative;
  ...
  object-fit: cover;
`;
const NaxosArcheologicalPark = styled.b`
  position: relative;
  line-height: 144%;
  ...
  flex-shrink: 0;
`;
const TaorminaTeatro1Parent = styled.div`
  ...
  padding: var(--padding-0) 0.000030517578125px var(--padding-0)
    var(--padding-0);
...
`;
const CardBest2 = memo(() => {
  return (
    <CardBestRoot>
      <Hotel1>
        <TaorminaTeatro1Parent>
          <TaorminaTeatro1Icon alt="" src="/taorminateatro-1@2x.png" />
          <NaxosArcheologicalPark>
